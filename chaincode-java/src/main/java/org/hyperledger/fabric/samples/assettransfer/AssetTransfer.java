...
public final class AssetTransfer implements ContractInterface {
     ...
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public String DuplicateAsset(final Context ctx, final String assetID, final String owner) {

        String newAssetId = "duplicate_" + assetID;
...
//        this.TransferAsset(ctx, newAssetId, owner);
